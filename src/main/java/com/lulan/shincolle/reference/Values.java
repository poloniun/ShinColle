...
//		put(ID.ShipType.,	new int[] {99, 87});  //empty for now
	...
	public static final Map<Integer, float[]> EquipMap = Collections.unmodifiableMap(new HashMap<Integer, float[]>() {{
		...
		put((int)ID.EquipType.TORPEDO_HI + (int)ID.EquipSubID.TORPEDO_HIGHSPEED * 100,  new float[]{1F, 400F,  200F,  200F,  200F, 200F,  20F, 8F,0.2F, 16F,   0F,    0F,    0.9F,    0.9F, 400F,400F,  ID.EquipType.TORPEDO_HI,   4000F,  40F,  1200, 2});
		//Torpedo aircraft
		...
		put((int)ID.EquipType.AIR_F_HI + (int)ID.EquipSubID.AIRCRAFT_FHELLCATK * 100, 	new float[]{3F, 400F,  200F,  200F,  200F, 200F,  20F, 8F,0.2F, 16F,   0F,    0F,    0.9F,    0.9F, 400F,400F,  ID.EquipType.AIR_F_HI,     4000F, 40F,  3800, 3});
		...
		put((int)ID.EquipType.RADAR_HI + (int)ID.EquipSubID.RADAR_FCSCIC * 100,       	new float[]{2F, 0F,  8F,  16F, 8F,  16F, 10F,0F,   -0.04F, 4F,   0.06F, 0F,    0F,    0.12F,  40F, 40F, ID.EquipType.RADAR_HI,     4000F,  4F,  2000, 0});
